...
// vovo youmeng bug 兼容，安卓 5.7.1
// TODO: 解决
if (navigator.userAgent.match(/android/ig)) {
    try {
        const brand = window.ground.getDeviceInfo().getDeviceModle();

        if (/vivo/ig.test(brand) || /oppo/ig.test(brand)) {
            UMAnalyticsAgent = {
                onEvent: function() {}
            }
        }        
...
console.log(UMAnalyticsAgent);

export default UMAnalyticsAgent;